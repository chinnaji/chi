  ...
  return (
    <p className="mt-10 flex flex-wrap  items-center px-3 md:gap-x-5  justify-center w-full text-4xl">
      {githubUrl && (
        <a
          href={githubUrl}
          className="lg:w-fit w-full  mx-auto lg:mx-0  items-center justify-center flex px-6 lg:px-12 text-base py-3  my-3 lg:my-9 bg-lime-500 hover:bg-lime-600 cursor-pointer rounded transition duration-100 ease-out hover:ease-in"
        >
          <span>
